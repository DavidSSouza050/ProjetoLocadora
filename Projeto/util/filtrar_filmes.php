...
<?php
    ...
    if(isset($_GET['categoria'])){
        ...
        if($categoria == 0){
            ...
            $where = "AND categoria.cod_categoria =".$categoria;
        }elseif($categoria != 0 && $subcategoria != 0){
            $where = "AND categoria.cod_categoria =".$categoria." AND genero.cod_genero =".$subcategoria;
        }
        ...
        if($modo == 'normal'){
            ...
            $sql = "SELECT DISTINCT filme.titulo_filme,
                    ...
                    WHERE filme.status_produto = 1 ".$where;
